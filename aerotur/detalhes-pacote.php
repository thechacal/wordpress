          ...
          <div id="titulo-recomendacoes">
            ...
            <div class="col-md-12 pacotes-no-padding-l">
              <div class="footerbar-pacote">
                ...
                <div class="col-xs-1 col-md-4">
                    <div class="moeda-new"><?= get_field('moeda_de_pagamento', get_the_ID());?></div>
                    <div class="parcela-new"><?= get_field('parcelas', get_the_ID());?> de</div>
                    <div class="valor-new">
                      <?= get_field('valor', get_the_ID());?>
                      <div class="cents-new">,<?= get_field('centavos', get_the_ID());?></div>
                    </div>
                </div>
                <div class="col-xs-1 col-md-4">
