 ...
 */
 ...
 <html lang="en">
   <head>
     ...
     <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/pacotes/assets/css/slippry-thumbs.css">
     ...
     <link rel="stylesheet" href="<?php bloginfo('template_url') ?>/pacotes/assets/css/jquery.bxslider.css">
     ...
     <script src="<?php bloginfo('template_url') ?>/pacotes/assets/js/ie-emulation-modes-warning.js"></script>
