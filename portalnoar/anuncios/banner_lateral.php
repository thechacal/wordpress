		...
		<div id="box_banner_lateral_200_446">
			...
			$query2 = new WP_Query( $args2 );
				if ( $query2->have_posts() ) :
					...
					if(get_field('tipo_de_anuncio',get_the_ID())=='Banner Vertical'){
					 ...
					 ?>
							<div class="item_banner_lateral_200_446" onclick="window.open('<?= get_field('link',get_the_ID()) ?>');" style="background-image:url('<?= $img2['url'] ?>');"></div>
							<?php
						}
					$aux=TRUE;
					}
